[dotenv@17.2.4] injecting env (10) from .env -- tip: ÔÜÖ´©Å  write to custom object with { processEnv: myObject }
// Sources flattened with hardhat v2.28.5 https://hardhat.org

// SPDX-License-Identifier: MIT

// File contracts/NFTMarketplaceSubscriptions.sol
...
contract NFTMarketplaceSubscriptions {
    ...
    uint256 public listingFee;       // comisi├│n fija por listar
    ...
    struct SubscriptionPlan {
        ...
        address tokenAddress;  // direcci├│n del token ERC20 (ej. USDC)
        uint256 duration;      // duraci├│n en segundos
    }
